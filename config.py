...
# 每条航线可配置:
#   alert_only: True = 只在 ALERT_DATES 的日期爬取（适合不常飞的航线，避免爬满30天）
...
# 告警过滤：仅这些航线+日期有价格变动才推送飞书（空列表=全部告警）
# 航线用 (出发代码, 到达代码) 元组，日期用字符串
# 两个条件同时生效：必须是告警航线 AND 告警日期才会推送
ALERT_ROUTES = [("bjs", "jjn"), ("bjs", "xmn")]   # 例: [("bjs", "jjn"), ("bjs", "xmn")]  仅北京出发
ALERT_DATES = ["2026-07-01", "2026-07-01"]    # 例: ["2026-07-15", "2026-07-20"]      仅这两天
...
# 监控设置
# ============================================================
MONITOR_INTERVAL_MINUTES = 240  # 监控间隔（分钟），30天数据量大，建议120以上
